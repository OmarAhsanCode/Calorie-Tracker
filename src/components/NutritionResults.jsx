...
const NutritionResults = ({ data, onAnalyzeAnother }) => {
  ...
  return (
    <div className="mt-8 bg-white rounded-xl shadow-lg p-6 sm:p-8 animate-fadeIn">
      ...
      {/* Total Calories */}
      <div className="bg-gradient-to-r from-primary-500 to-primary-600 rounded-lg p-6 mb-6 text-white text-center">
        <h4 className="text-lg font-medium mb-2">Total Calories</h4>
        <p className="text-4xl font-bold">{calories}</p>
        <p className="text-primary-100">kcal</p>
      </div>
          ...
          {food.map((item, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-4 flex justify-between items-center">
              ...
              <div className="grid grid-cols-4 gap-4 text-center text-sm">
                ...
                <div>
                  <p className="font-semibold text-blue-600">{item.carbs}g</p>
                  <p className="text-gray-500">carbs</p>
                </div>
                <div>
                  <p className="font-semibold text-yellow-600">{item.fat}g</p>
